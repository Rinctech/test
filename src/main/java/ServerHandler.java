...
public class ServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws IOException {
        ...
        final Properties props = KafkaAvroProducer.loadConfig("kafka.properties");
        ...
        logger.info("Producing record: "+ new Date()+ " - " + key + " - " + record);
        producer.send(new ProducerRecord<>(topic, key, record), new Callback() {
            @Override
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        ...
        logger.info("Exeception raised Closing connection");
